(function() {
    ...
    window.app = {
        ...
        sendActionWebhook() {
            ...
            if (!tipo || !dataF_input || !hora || !resultado) {
                return this.showToast("Preencha todos os dados da ação!", "error");
            }

            if (this.state.participants.size === 0) {
                return this.showToast("Adicione pelo menos um participante!", "error");
            }
        ...
        async sendSaleWebhook() {
            ...
            if (!vendedor || !faccao || !dataInput || !horaInput) {
                return this.showToast("Preencha todos os campos de venda!", "error");
            }

            if (this.state.cart.length === 0) {
                return this.showToast('O carrinho não pode estar vazio!', 'error');
            }
            ...
            const embedVenda = {
                ...
                embeds: [{
                    ...
                    fields: [
                        ...
                        { name: "Facção Compradora", value: vendaData.faccao, inline: true },
        ...
        async loadDashboard() {
            ...
            try {
                ...
                const snapshot = await window.db.collection("vendas_trojan")
